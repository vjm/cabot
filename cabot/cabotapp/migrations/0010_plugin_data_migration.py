...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        #
        update_contenttypes(get_app('cabotapp'), get_models())
        ...
        try:
            ...
            email_alert = orm['cabot_alert_email.EmailAlert'](
                title = "Email",
                polymorphic_ctype = orm['contenttypes.contenttype'].objects.get(model='emailalert'),
                )
            email_alert.save()
